...
class SettingsWindow(ctk.CTkToplevel):
    ...
    def build_ui(self):
        ...
        icon_frame = ctk.CTkFrame(header, width=50, height=50, corner_radius=10,
                                  fg_color="#18181B", border_width=1, border_color="#27272A")
        ...
        for label, idx in tabs:
            btn = ctk.CTkButton(
                ...
                fg_color="#27272A" if idx == 0 else "transparent",
                hover_color="#18181B",
    ...
    def _switch_tab(self, index):
        ...
        for i, btn in enumerate(self.tab_buttons):
            if i == index:
                btn.configure(fg_color="#27272A", text_color=COLOR_TEXT_MAIN)
            else:
    ...
    def _build_general_tab(self):
        ...
        perf_info = ctk.CTkFrame(perf_section, fg_color="#09090B", corner_radius=8)
    ...
    def _build_about_tab(self):
        ...
        logo_frame = ctk.CTkFrame(info_card, width=80, height=80, corner_radius=16,
                                 fg_color="#18181B", border_width=2, border_color="#27272A")
